...
type runner struct {
	...
	runQueue     map[string]*exec.Cmd
	runQueueLock sync.Locker
...
func (b *runner) handle(p *myproto.Message) error {
	b.log.Info("handle:\n%s\n", myproto.Debug(p))
...
func (b *runner) initLog(prefix string) (err error) {
...
func (b *runner) init() error {
	...
	b.runQueue = make(map[string]*exec.Cmd)
	b.runQueueLock = &sync.Mutex{}
...
func (b *runner) timerOnce(to int64, typ string, ch interface{}, cmd interface{}) {
